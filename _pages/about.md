...
个人简介
======
研究方向：基于后摩尔新器件的集成电路与硬件系统设计

主要成果：在后摩尔新器件硬件架构与算子电路上取得突破，已发表和正式接收论文42篇（其中第一作者10篇、通讯作者10篇，含共一/共通讯），具体包括：（1）在多模式异构片上网络架构上，设计了多款通信与AI算法加速芯片与硬件系统（包括神经微分方程、4G低密度奇偶校验码、5G极化码等），发表集成电路架构顶级期刊/会议IEEE JSSC、VLSI、HPCA等一作/通讯论文4篇，以及电路系统顶级期刊/会议IEEE TCAS-I、FPGA等一作/通讯论文7篇；（2）在多物理域可重构算子电路上，基于后摩尔新型器件设计了多款算子加速电路（包括傅里叶变换、频率生成/转换、大数据排序等），相关工作已发表和正式接收Nature Electronics等子刊一作/通讯论文3篇，以及芯片领域顶级期刊/会议IEDM、MICRO等一作/通讯论文6篇。

获北京大学博雅青年学者、华为未名青年学者、北京智源人工智能青年科学家（青源学者）等，曾获高通技术明星奖3次、华为计算产品线最佳技术合作奖、通信两大顶会之一IEEE Globecom最佳论文奖（2/300+）、芯片领域顶级会议最佳论文奖提名2次（IEEE VLSI、IEEE ISCAS）。研究成果入选2025年度中国半导体十大进展候选，曾获人民网、新华网、Yahoo等海内外媒体亮点报道；申请/获批中美发明专利18项，部分技术转化至华为、高通、德州仪器、知存科技等企业落地实用，相关芯片开具证明量产出货超亿颗。主持国家级高层次青年人才项目（海外）、国自然基金委面上项目、国自然基金委“后摩尔重大研究计划“重点项目（课题负责人）、科技部国家重点研发计划项目（课题负责人）、北京市自然基金委非共识项目、华为计算产品线/数通产品线技术合作项目等，个人主持经费超千万余元。在北京大学元培学院主讲2门芯片相关本科生选修课程，曾在教学评估中位列元培学院40余门选修课第3名，并入选北京大学数字精品教材工程。
