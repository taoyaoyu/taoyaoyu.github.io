...
主要成果：在后摩尔新器件硬件架构与算子电路上取得突破，发表论文40余篇（其中第一作者10篇、通讯作者10篇，含共一/共通讯），具体包括：（1）在多模式异构片上网络架构上，设计了多款通信与AI算法加速芯片与硬件系统（包括神经微分方程、4G低密度奇偶校验码、5G极化码等），发表集成电路架构顶级期刊/会议IEEE JSSC、VLSI、HPCA等一作/通讯论文4篇，以及电路系统顶级期刊/会议IEEE TCAS-I、FPGA等一作/通讯论文7篇；（2）在多物理域可重构算子电路上，基于后摩尔新型器件设计了多款算子加速电路（包括傅里叶变换、频率生成/转换、大数据排序等），相关工作已发表和正式接收Nature Electronics等子刊一作/通讯论文3篇，以及芯片领域顶级期刊/会议IEDM、MICRO等一作/通讯论文6篇。
